...
- [x] **Main screen** — V1.3.82: `retry_zp` ($B2) tracks how many attempts `checkrealsid` needed; a `*` is appended after "6581 FOUND"/"8580 FOUND" on the main screen if any retries were required (VIC bad-line DMA steal)
...
- [x] **GitHub README** — updated to v1.3.82; Known issues updated with V1.3.82 retry indicator
