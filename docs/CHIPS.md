...
Reference for every SID variant detected by SID Detector v1.5.09, plus chips with placeholder screen rows. Covers the original hardware, all known clones and emulators, and how the detection code identifies each one.
